  ...
  return (
    <div className="main">
      <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li><a href="#" className="nav-link px-2 link-dark  btn-outline-light px-2 " title="Home">
        ...
        <li><a href="#" className="nav-link px-2 link-dark  btn-outline-light" title="Trademark">Trademark</a></li>
        <li><a href="#" className="nav-link px-2 link-dark  btn-outline-light" title="Watch`s">Watch`s</a></li>
        <li><a href="#" className="nav-link px-2 link-dark  btn-outline-light" title="News">News</a></li>
        <li><a href="#" className="nav-link px-2 link-dark  btn-outline-light" title="Contact">Contact</a></li>
